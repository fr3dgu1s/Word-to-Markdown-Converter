...
| ![spec-image](Images/spec-onelake-security-sql-endpoint-for-markdown/image_1.png)   | Jasmin  **Big Data Resource Manager**  Manage big data resources for a team. Coordinate, reallocate or provide data resources (storage or compute) as needed.   |
|---------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------|

| ![spec-image](Images/spec-onelake-security-sql-endpoint-for-markdown/image_2.png)   | Anna  **Data Analyst**  Frame a business problem; Analyze data to help leaders make business decisions.   |
|---------------|-----------------------------------------------------------------------------------------------------------|
